# ACS (**American Community Survey**) data shape diagram — wide rows vs variable groups
...
(place population vs estimate size) · [`notebooks/06-composite-reliability-and-cv-drivers.ipynb`](../notebooks/06-composite-reliability-and-cv-drivers.ipynb) (Section 7, the former EDA 07).
