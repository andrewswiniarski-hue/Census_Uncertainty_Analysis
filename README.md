...
- [x] **Done when:** notebooks are committed with markdown commentary, and we have 2–3 charts worth showing mentors *(satisfied 2026-07-15 — notebooks 01–03 committed, four mentor-ready charts in `data/processed/`; EDA 04 added three more 2026-07-16; the allocation-rate question above remains open as EDA #5)*
