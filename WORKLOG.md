...
- **Files:** ingestion/pull_acs_us.py; Explore.py (commit `<f47d6da>`); outputs `data/raw/acs5_2024_us_*.parquet`, `data/raw/geo_2024_us_*.parquet`, `data/raw/verification_map_us_counties.png`, and `data/raw/us_county_median_household_income.png` (local only, regenerable).
